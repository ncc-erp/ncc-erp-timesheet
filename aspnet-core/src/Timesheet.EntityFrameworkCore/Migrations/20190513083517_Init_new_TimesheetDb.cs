...
{
    public partial class Init_new_TimesheetDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleterUserId = table.Column<long>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    ProjectTaskId = table.Column<long>(nullable: false),
                    UserId = table.Column<long>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MyTimesheets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MyTimesheets_TaskProjects_ProjectTaskId",
                        column: x => x.ProjectTaskId,
                        principalTable: "TaskProjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MyTimesheets_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MyTimesheets_ProjectTaskId",
                table: "MyTimesheets",
                column: "ProjectTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_MyTimesheets_UserId",
                table: "MyTimesheets",
                column: "UserId");
