    ...
    public class HRMv2AppService_Test : TimesheetApplicationTestBase
    {
        ...
        public async Task GetPunishmentBasicUserUnlockTS_Test()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.Last().Email.ShouldBe("testemail12@gmail.com");
        ...
        public async Task GetPunishmentPMUnlockTS_Test()
        {
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.Last().Email.ShouldBe("testemail13@gmail.com");
        ...
        public async Task GetPunishtmentCheckin_Test()
        {
            ...
            WithUnitOfWork(() =>
           {
               ...
               {
                   UserId = 22,
                   UserEmail = "testemail22@email.com",
                   CheckIn = "10:00",
                   CheckOut = "17:00",
            ...
            WithUnitOfWork(() =>
            {
                ...
                Assert.Equal(expectTotalCount, result.Count());
                result.Last().Email.ShouldBe("testemail22@gmail.com");
        ...
        public async Task GetAllRequestDay_Test()
        {
            InputCollectDataForPayslipDto input = new InputCollectDataForPayslipDto
            {
                Year = 2022,
                Month = 12,
                UpperEmails = new List<string> { "TESTEMAIL6@GMAIL.COM", "TESTEMAIL17@GMAIL.COM" }
            };
            ...
            WithUnitOfWork(() =>
            {
                ...
                result.First().NormalizedEmailAddress.ShouldBe("TESTEMAIL17@GMAIL.COM");
        ...
        public async Task GetChamCongInfo_Test()
        {
            ...
            WithUnitOfWork(() =>
            {
                ...
                result.First().NormalizeEmailAddress.ShouldBe("TESTEMAIL17@GMAIL.COM");
        ...
        public async Task GetOTTimesheets_Test()
        {
            ...
            var input = new InputCollectDataForPayslipDto
            {
                Month = 12,
                Year = 2022,
                UpperEmails = new List<String> { "ADMIN@ASPNETBOILERPLATE.COM", "TESTEMAIL9@GMAIL.COM" }
            };
        ...
        public async Task ConfirmUserQuit_Should_Throw_Exception()
        {
            var input = new UpdateUserStatusFromHRMDto
            {
                EmailAddress = "test1email@gmail.com",
                DateAt = DateTime.Now,
            };
        ...
        public void GetDicUserIdToOpentalkCount_Test1()
        {
            ...
            output.Add("TESTEMAIL6@GMAIL.COM", 2);
        ...
        public void GetChamCongInfo_Test1()
        {
            InputCollectDataForPayslipDto input = new InputCollectDataForPayslipDto
            {
                Year = 2023,
                Month = 7,
                UpperEmails = new List<string> { "TESTEMAIL6@GMAIL.COM" }
            };
        ...
        public void ProcessOpentalkOneUserByNewWay_Test1()
        {
            ...
            {
                NormalizeEmailAddress = "TESTEMAIL6@GMAIL.COM",
