    ...
    public class HRMAppService_Test : HRMAppServiceTestBase
    {
        ...
        public void GetAllNormalWorkingTest1()
        {
            ...
            WithUnitOfWork(() =>
            {
                ...
                result[4].NormalizedEmailAddress.ShouldBe("TESTEMAIL6@GMAIL.COM");
        ...
        public void GetAllOverTimeTest1()
        {
            ...
            WithUnitOfWork(async() =>
            {
                ...
                result[0].NormalizedEmailAddress.ShouldBe("TESTEMAIL6@GMAIL.COM");
        ...
        public void GetAllAbsencedayTest1()
        {
            ...
            WithUnitOfWork(async() =>
            {
                ...
                result[0].NormalizedEmailAddress.ShouldBe("TESTEMAIL17@GMAIL.COM");
        ...
        public void GetAllProjectTest1()
        {
            WithUnitOfWork( async() =>
            {
                ...
                result[0].Code.ShouldBe("Project 1");
        ...
        public void GetUserRegisterTimeTest1()
        {
            ...
            WithUnitOfWork(async () =>
            {
                ...
                result[0].EmailAddress.ShouldBe("testemail17@gmail.com");
        ...
        public void GetRequestByTimeAndTypeTest1()
        {
            ...
            WithUnitOfWork(async () =>
            {
                ...
                result[0].FullName.ShouldBe("email17 test");
                ...
                result[0].Name.ShouldBe("email17");
                result[0].Reason.ShouldBe("cưới");
                result[0].Sex.ShouldBe(Sex.Female);
                result[0].ShortName.ShouldBe("email17");
        ...
        public void GetAllPublishmentTest1()
        {
            ...
            WithUnitOfWork(async () =>
            {
                ...
                result[0].NormalizedEmailAddress.ShouldBe("TESTEMAIL15@GMAIL.COM");
