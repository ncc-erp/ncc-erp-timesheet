    ...
    public class EmailSaoDoSetting_Tests : TimesheetApplicationTestBase
    {
        ...
        public async Task Change_Happy_Test()
        {
            ...
            var emaiSaoDo = new EmaiSaoDoDto
            {
                ...
                EmailSaoDo = "saodotest@gmail.com"
            };
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.EmailSaoDo.ShouldBe("saodotest@gmail.com");
            });
            ...
            WithUnitOfWork(() =>
            {
                ...
                result.Find(x => x.Name.Equals("App.EmailSaoDo")).Value.ShouldBe("saodotest@gmail.com");
            });
        }
    }
}
