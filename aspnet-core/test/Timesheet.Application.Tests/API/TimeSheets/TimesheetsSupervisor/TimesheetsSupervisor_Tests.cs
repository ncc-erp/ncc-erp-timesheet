    ...
    public class TimesheetsSupervisor_Tests : TimesheetApplicationTestBase
    {
        ...
        public async Task GetAll_Happy_Test()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                myTimeSheet.CustomerName.ShouldBe("Client 3");
                myTimeSheet.ProjectCode.ShouldBe("Project 3");
                myTimeSheet.ProjectId.ShouldBe(5);
                myTimeSheet.ProjectName.ShouldBe("Project 3");
                ...
                myTimeSheet.User.ShouldBe("email6 test");
