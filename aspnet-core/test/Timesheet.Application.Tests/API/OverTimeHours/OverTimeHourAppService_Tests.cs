    ...
    public class OverTimeHourAppService_Tests : TimesheetApplicationTestBase
    {
        ...
        public async Task Should_Get_all_Paging()
        {
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.Items.ShouldContain(x => x.EmailAddress == "hieu.trantrung@ncc.asia");
        ...
        public async Task Should_Get_Over_Time_For_HRM()
        {
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.ShouldContain(x => x.NormalizedEmailAddress == "HIEU.TRANTRUNG@NCC.ASIA");
                result.ShouldContain(x => x.NormalizedEmailAddress == "DUONG.TRANDUC@NCC.ASIA");
                result.ShouldContain(x => x.NormalizedEmailAddress == "MY.NGHIEMTHITRAMY@NCC.ASIA");
        ...
        public async Task Should_Get_Over_Time_For_HRMv2()
        {
            await WithUnitOfWorkAsync(async () =>
            {
                var input = new InputCollectDataForPayslipDto
                {
                    ...
                    {
                        "HIEU.TRANTRUNG@NCC.ASIA",
                        "DUONG.TRANDUC@NCC.ASIA",
                        "MY.NGHIEMTHITRAMY@NCC.ASIA",
                        "TRANG.QUYNHVU@NCC.ASIA"
                    }
                };
                ...
                result.ShouldContain(x => x.NormalizedEmailAddress == "MY.NGHIEMTHITRAMY@NCC.ASIA" && x.ListOverTimeHour.Count == 1);
                result.ShouldContain(x => x.NormalizedEmailAddress == "DUONG.TRANDUC@NCC.ASIA" && x.ListOverTimeHour.Count == 2);
            });
        }
        ...
        public async Task Should_Get_List_Over_Time_For_Chart()
        {
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                var inputProjectCode = "Project abc";
                ...
                result.ShouldContain(x => x.EmailAddress == "hieu.trantrung@ncc.asia");
        ...
        public async Task Should_Get_ProjectCode_By_Id()
        {
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                Assert.Equal("Project abc", result);
            });
        }
    }
}
