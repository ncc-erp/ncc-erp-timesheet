    ...
    public class RetroResultAppService_Test : TimesheetApplicationTestBase
    {
        ...
        public async void GetAllUsersNotInTheRetroResultByRetroIdTest1()
        {
            ...
            await WithUnitOfWorkAsync(() => {
                ...
                result.Result.First().FullNameAndEmail.ShouldBe("email7 test - testemail7@gmail.com");
        ...
        public async void GetAllUsersNotInTheRetroResultByRetroIdTest2()
        {
            ...
            await WithUnitOfWorkAsync(() => {
                ...
                result.Result[1].FullNameAndEmail.ShouldBe("email3 test - testemail3@gmail.com");
        ...
        public async void GetAllProjectTest1()
        {
            ...
            await WithUnitOfWorkAsync(() => {
                ...
                result.Result.First().Code.ShouldBe("Project 1");
        ...
        public async void GetProjectPMRetroTest1()
        {
            await WithUnitOfWorkAsync(() => {
                ...
                Assert.NotNull(result);
                result.Result.Count.ShouldBe(3);
                result.Result.First().Code.ShouldBe("Client 2");
        ...
        public async void GetProjectPMRetroResultTest1()
        {
            ...
            await WithUnitOfWorkAsync(() => {
                ...
                result.Result.First().Code.ShouldBe("Project 1");
                result.Result.First().Id.ShouldBe(1);
                result.Result.First().Name.ShouldBe("Project 1");
                return System.Threading.Tasks.Task.CompletedTask;
            });
        }
        ...
        public async void ImportRetroUserFromFileTest1()
        {
            ...
            await WithUnitOfWorkAsync(async() => {
                ...
                warnlist.First().ShouldBe("testemail12@gmail.com [Project Training]");
        ...
        public async void ImportRetroUserFromFileTest5()
        {
            ...
            await WithUnitOfWorkAsync(async () => {
                ...
                successlist.First().ShouldBe("testemail11@gmail.com");
            });
        }
        ...
        public async void ImportRetroUserFromFileTest6()
        {
            ...
            await WithUnitOfWorkAsync(async () => {
                ...
                failedlist.First().ShouldBe("testemail17@gmail.com");
            });
        }
        ...
        public async void ImportRetroUserFromFileTest7()
        {
            ...
            await WithUnitOfWorkAsync(async () => {
                ...
                var errorList = resultProperties.First(o => o.Name == "errorList").GetValue(result, null) as List<string>;
                errorList.Count.ShouldBe(1);
                errorList.First().ShouldBe("Row 2:  Can not find User by Email: testemail117@gmail.com, Point can not be less than 0 or greater than 5");
            });
        }
        ...
        public async void ConfirmImportRetroTest1()
        {
            ...
            await WithUnitOfWorkAsync(async () => {
                ...
                result.First().ShouldBe("testemail11@gmail.com");
            });
        }
        ...
        public async void GetAllPagingTest1()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.Items.First().EmailAddress.ShouldBe("testemail3@gmail.com");
                result.Items.First().FullName.ShouldBe("email3 test");
                ...
                result.Items.First().ProjectName.ShouldBe("Project 1");
        ...
        public async void GetAllPagingTest2()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.Items.First().EmailAddress.ShouldBe("testemail6@gmail.com");
                result.Items.First().FullName.ShouldBe("email6 test");
