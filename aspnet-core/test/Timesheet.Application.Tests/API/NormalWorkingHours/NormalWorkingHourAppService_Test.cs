    ...
    public class NormalWorkingHourAppService_Test : TimesheetApplicationTestBase
    {
        ...
        public async void TestGetAllPagging()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.Items.ShouldContain(item => item.EmailAddress == "testemail3@gmail.com");
                result.Items.ShouldContain(item => item.FullName == "test email3");
        ...
        public async void TestGetAllPagging_BranchHN()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.Items.ShouldContain(item => item.AvatarPath == "");
                result.Items.ShouldContain(item => item.Branch == null);
                result.Items.ShouldContain(item => item.EmailAddress == "testemail22@gmail.com");
                result.Items.ShouldContain(item => item.FullName == "test email22");
                result.Items.ShouldContain(item => item.IsPM == false);
                result.Items.ShouldContain(item => item.Level == null);
                result.Items.ShouldContain(item => item.Name == "email22");
                result.Items.ShouldContain(item => item.Surname == "test");
            });
        }
