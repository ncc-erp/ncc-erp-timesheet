    ...
    public class PublicAppService_Tests : TimesheetApplicationTestBase
    {
        ...
        public async Task GetUserWorkFromHome_Test()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.First().EmailAddress.ShouldBe("hieu.trantrung@ncc.asia");
        ...
        public async Task GetAllUserLeaveDay_Test()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.Last().EmailAddress.ShouldBe("hieu.trantrung@ncc.asia");
        ...
        public async Task GetAllUserByEmail_Test()
        {
            ...
            var listEmail = new List<String> { "admin@aspnetboilerplate.com", "toai.nguyencong@ncc.asia", "chi.trantung@ncc.asia", "nhi.tranthianh@ncc.asia" };
            ...
            WithUnitOfWork(() =>
            {
                ...
                result.Last().FullName.ShouldBe("Nhi Trần Thị Ánh");
                result.Last().EmailAddress.ShouldBe("nhi.tranthianh@ncc.asia");
        ...
        {
            var email = "hieu.trantrung@ncc.asia";
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.EmailAddress.ShouldBe("hieu.trantrung@ncc.asia");
        ...
        public async Task KmGetAllUsers_Test()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                Assert.Equal(expectTotalCount, result.Count());
                result.Last().EmailAddress.ShouldBe("hien.ngothu@ncc.asia");
                result.Last().UserName.ShouldBe("hien.ngothu@ncc.asia");
                result.Last().FullName.ShouldBe("Hiền Ngô Thu");
                result.Last().Name.ShouldBe("Hiền");
                result.Last().Surname.ShouldBe("Ngô Thu");
            });
        }
        ...
        {
            var emailAddress = "hieu.trantrung@ncc.asia";
        ...
        {
            var emailAddress = "aaaahieu.trantrung@ncc.asia";
        ...
        public async Task GetTimesheetOfUserInProject_Test()
        {
            await WithUnitOfWorkAsync(async () =>
            {
                var result = await _publicAppService.GetTimesheetOfUserInProject("Project UCG", "hieu.trantrung@ncc.asia", DateTime.Parse("2022/12/01"), DateTime.Parse("2022/12/31"));

                result.ProjectId.ShouldBe(1);
                result.ProjectCode.ShouldBe("Project UCG");
        ...
        public async Task GetTimesheetOfUserInProjectNew_Test()
        {
            WithUnitOfWork(() =>
            {
                var result = _publicAppService.GetTimesheetOfUserInProjectNew("Project UCG", "hieu.trantrung@ncc.asia", DateTime.Parse("2022/12/01"), DateTime.Parse("2022/12/31"));
        ...
        public async Task GetTimesheetOfUserInProjectNew_Should_Not_Get_Because_Project_Is_Null()
        {
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                {
                    _publicAppService.GetTimesheetOfUserInProjectNew("", "abc@ncc.asia", DateTime.Parse("2022/12/01"), DateTime.Parse("2022/12/30"));
                });
        ...
        public async Task GetUserInProjectFromTimesheet_Test()
        {
            WithUnitOfWork(() =>
           {
               var result = _publicAppService.GetUserInProjectFromTimesheet("Project UCG", new List<String> { "admin@aspnetboilerplate.com", "hien.ngothu@ncc.asia" }, DateTime.Parse("2022/12/01"), DateTime.Parse("2022/12/31"));
        ...
        public async Task GetUserInProjectFromTimesheet_Should_Not_Get_Because_Project_Is_Null()
        {
            await WithUnitOfWorkAsync(async () =>
            {
                var exception = await Assert.ThrowsAsync<UserFriendlyException>(async () =>
                {
                    var result = _publicAppService.GetUserInProjectFromTimesheet("", new List<String> { "abc@ncc.asia", "xyz@ncc.asia" }, DateTime.Parse("2022/12/01"), DateTime.Parse("2022/12/30"));
                });
                Assert.Equal("project code is null or empty", exception.Message);
            });
        }*/
        ...
        public async Task GetTimesheetWeeklyChartOfUserInProject_Should_Not_Get_Because_Project_Code_Is_Null()
        {
            await WithUnitOfWorkAsync(async () =>
            {
                var exception = await Assert.ThrowsAsync<UserFriendlyException>(async () =>
                {
                    await _publicAppService.GetTimesheetWeeklyChartOfUserInProject("", "abc@ncc.asia", DateTime.Parse("2022/12/01"), DateTime.Parse("2022/12/30"));
                });
                Assert.Equal("project code is null or empty", exception.Message);
            });
        }
        ...
        public async Task GetTimesheetWeeklyChartOfUserInProject_Should_Not_Get_Because_Email_Is_Null()
        {
            await WithUnitOfWorkAsync(async () =>
            {
                var exception = await Assert.ThrowsAsync<UserFriendlyException>(async () =>
                {
                    await _publicAppService.GetTimesheetWeeklyChartOfUserInProject("Project UCG", "", DateTime.Parse("2022/12/01"), DateTime.Parse("2022/12/30"));
                });
        ...
        public async Task GetTimesheetWeeklyChartOfProject_Should_Get()
        {
            await WithUnitOfWorkAsync(async () =>
            {
                var result = await _publicAppService.GetTimesheetWeeklyChartOfProject("Project UCG", DateTime.Parse("2022/12/01"), DateTime.Parse("2022/12/30"));
                result.Labels.Count.ShouldBe(5);
                result.NormalWoringHours.Count.ShouldBe(5);
                result.OTNoChargeHours.Count.ShouldBe(5);
                result.OverTimeHours.Count.ShouldBe(5);
        ...
        public async Task GetTimesheetWeeklyChartOfUserGroupInProject_Should_Get()
        {
            var input = new InputGetTimesheetChartOfUserGroupDto
            {
                ...
                Emails = new List<String> { "hien.ngothu@ncc.asia", "admin@aspnetboilerplate.com" },
        ...
        public async Task GetTimesheetWeeklyChartOfUserGroupInProject_Should_Not_Get_Because_Project_Code_Is_Null()
        {
            ...
            {
                ProjectCode = "",
                Emails = new List<String> { "abc@ncc.asia" },
                StartDate = DateTime.Parse("2022/12/01"),
                EndDate = DateTime.Parse("2022/12/30")
            };
        ...
        public async Task GetTimesheetDetailForTax_Test()
        {
            ...
            {
                ProjectCodes = new List<string> { "Project UCG" },
                Month = 12,
                Year = 2022
            };
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.ListTimesheet.Last().ActualEmailAddress.ShouldBe("hieu.trantrung@ncc.asia");
                ...
                result.ListTimesheet.Last().EmailAddress.ShouldBe("hieu.trantrung@ncc.asia");
                result.ListTimesheet.Last().ManDay.ShouldBe(1);
                result.ListTimesheet.Last().ProjectCode.ShouldBe("Project UCG");
                result.ListTimesheet.Last().ProjectName.ShouldBe("Project UCG");
        ...
        public async Task GetDataForCheckPoint_Test()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                Assert.Equal("{ UserId = 17, FullName = Trang Vũ Quỳnh, EmailAddress = trang.vuquynh@ncc.asia, Branch = [Branch 1], BranchName = [Branch 1], Type = Staff, TypeName = Staff, LevelName = JuniorMinus, ReviewerId = 1, ReviewerName = admin admin, ReviewerEmail = admin@aspnetboilerplate.com }", result.Last().ToString());
            });
        }
        ...
        public async Task GetPMsOfUser_Test()
        {
            ...
            WithUnitOfWork(() =>
           {
               var result = _publicAppService.GetPMsOfUser("trang.vuquynh@ncc.asia");
               Assert.Equal(expectTotalCount, result.Count);

               result.First().PMs.Count.ShouldBe(2);
               result.First().PMs.Last().BranchName.ShouldBe("HN1");
               result.First().PMs.Last().EmailAddress.ShouldBe("trang.vuquynh@ncc.asia");
               result.First().PMs.Last().FullName.ShouldBe("Trang Vũ Quỳnh");
               result.First().PMs.Last().UserTypeName.ShouldBe("Staff");
               result.First().PMs.Last().UserType.ShouldBe(Usertype.Staff);
               result.First().ProjectCode.ShouldBe("Project abc");
               result.First().ProjectName.ShouldBe("Project abc");
           });
        }
        ...
        public async Task GetTimesheetAndCheckInOutAllUser_Test()
        {
            ...
            WithUnitOfWork(() =>
            {
                ...
                result.First().EmailAddress.ShouldBe("trang.vuquynh@ncc.asia");
                result.First().FullName.ShouldBe("Trang Vũ Quỳnh");
        ...
        public async Task GetCurrentWorkingTimeAllUserWorking_Test()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.Last().UserEmail.ShouldBe("hien.ngothu@ncc.asia");
