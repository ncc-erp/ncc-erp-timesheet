...
@Component({
  selector: 'app-view-leave-day-of-user',
  templateUrl: './view-leave-day-of-user.component.html',
  styleUrls: ['./view-leave-day-of-user.component.css'],
  providers: [DatePipe]
})

export class ViewLeaveDayOfUserComponent extends AppComponentBase implements OnInit {
  ...
  constructor(
    ...
    this.years = [];
    for (let i = this.viewDate.getFullYear() - 2; i <= this.viewDate.getFullYear() + 1; i++) {
      this.years.push(i);
    }
  }
