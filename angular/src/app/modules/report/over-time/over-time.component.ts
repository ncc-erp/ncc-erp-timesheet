...
export class OverTimeComponent extends PagedListingComponentBase<OverTimeItem> implements OnInit {
  ...
  protected list(request: PagedRequestDto, pageNumber: number, finishedCallback: Function): void {
    ...
    this.overTimeService
      .getAll(request, this.month + 1, this.year, this.projectId, this.overtimeType)
      .pipe(finalize(() => {
        finishedCallback();
      }))
      .subscribe((result: any) => {
        ...
        this.overTimeService.getAll(allDataRequest, this.month + 1, this.year, this.projectId, this.overtimeType)
