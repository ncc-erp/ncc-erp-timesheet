...
export class TimesheetService extends BaseApiService {
  submitTimesheet(timesheetId: any): any {
    return this.http.post(
      this.getUrl("SubmitTimesheet?timesheetId=" + timesheetId),
      {}
    );
  }
  ...
  getAllTimesheets(
    ...
    params = params.append(
      "opentalkTimeType",
      this.getPara(OpenTalkJoinTimeType)
    );
  ...
  changeStatusService(id: number, statusCode: number): Observable<any> {
    return this.http.post(
      this.getUrl("ChangeStatusTimesheet?id=" + id),
      statusCode
    );
  }
  ...
  getTimesheetReport(fromDate, toDate): Observable<any> {
    return this.http.get(
      this.getUrl(`GetTimesheetReport?fromDate=${fromDate}&toDate=${toDate}`)
    );
  }

  getProjectList(fromDate, toDate): Observable<any> {
    return this.http.get(
      this.getUrl(`GetProjectList?fromDate=${fromDate}&toDate=${toDate}`)
    );
  }

  getTaskList(fromDate, toDate): Observable<any> {
    return this.http.get(
      this.getUrl(`GetTaskList?fromDate=${fromDate}&toDate=${toDate}`)
    );
  }

  getTeamList(fromDate, toDate): Observable<any> {
    return this.http.get(
      this.getUrl(`GetTeamList?fromDate=${fromDate}&toDate=${toDate}`)
    );
  }

  getCustomerList(fromDate, toDate): Observable<any> {
    return this.http.get(
      this.getUrl(`GetCustomerList?fromDate=${fromDate}&toDate=${toDate}`)
    );
  }
  ...
  getAllTimeSheetOrRemote(day, type): Observable<any> {
    return this.http.get(
      this.getUrl(`GetAllTimeSheetOrRemote?day=${day}&type=${type}`)
    );
  }
  getQuantiyTimesheetStatus(
    ...
    params = params.append("workLocation", this.getPara(workLocationFilter));
    return this.http.get(this.getUrl("GetQuantiyTimesheetStatus"), {
      params: params,
    });
  }
  ...
  getTimesheetWarning(myTimesheetIds) {
    return this.http.post(
      this.rootUrl + "/GetTimesheetWarning",
      myTimesheetIds
    );
  }
}
