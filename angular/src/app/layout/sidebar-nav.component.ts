...
import { Router, ActivatedRoute, NavigationEnd, RouterEvent, PRIMARY_OUTLET } from '@angular/router';
...
export class SideBarNavComponent extends AppComponentBase {
    ...
    getMenuItems(): MenuItem[] {
        return [
            new MenuItem(this.l('My information'), 'MyProfile', 'account_box', '/app/main/my-profile'),
            ...
            new MenuItem(this.l('Management'), '', 'group_work', '', [
                new MenuItem(this.l("Manage off/remote/onsite requests"), "AbsenceDayByProject", 'rule', '/app/main/off-day-project'),
                new MenuItem(this.l('Timesheet management'), 'Timesheet', 'date_range', '/app/main/timesheets'),
    ...
    activateMenuItems(url: string): void {
        ...
        console.log("foundedItems", foundedItems)
    ...
    activateMenuItem(item: MenuItem): void {
        ...
        console.log("activeMenuItems", this.activatedMenuItems)
    }
