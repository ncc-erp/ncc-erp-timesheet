export const PERMISSIONS_CONSTANT = {
    ...
    ViewNHPMAPRITSetting: "Admin.Configuration.NHPMAPRITConfig.ViewNHPMAPRITConfig",
    EditNHPMAPRITSetting: "Admin.Configuration.NHPMAPRITConfig.UpdateNHPMAPRITConfig",
