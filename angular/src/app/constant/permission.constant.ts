export const PERMISSIONS_CONSTANT = {
    ...
    ViewLogoutAllUserSetting: "Admin.Configuration.LogoutAllUser.ViewLogoutAllUser",
    ...
    EditLogoutAllUserSetting: "Admin.Configuration.LogoutAllUser.EditLogoutAllUser",
    ...
    ViewNRITVMAESetting: "Admin.Configuration.NRITVMAEConfig.ViewNRITVMAEConfig",
    EditNRITVMAESetting: "Admin.Configuration.NRITVMAEConfig.UpdateNRITVMAEConfig",
    ...
    ViewCreateNewRetroSetting: "Admin.Configuration.CreateNewRetroConfig.ViewCreateNewRetroConfig",
    EditCreateNewRetroSetting: "Admin.Configuration.CreateNewRetroConfig.UpdateCreateNewRetroConfig",
    ViewGenerateRetroResultSetting: "Admin.Configuration.GenerateRetroResultConfig.ViewGenerateRetroResultConfig",
    EditGenerateRetroResultSetting: "Admin.Configuration.GenerateRetroResultConfig.UpdateGenerateRetroResultConfig",
    ...
    // Tracker Whitelist
    ViewTrackerWhitelist: "Admin.TrackerWhitelist.View",
    AddTrackerWhitelist: "Admin.TrackerWhitelist.Add",
    EditTrackerWhitelist: "Admin.TrackerWhitelist.Edit",
    DeleteTrackerWhitelist: "Admin.TrackerWhitelist.Delete",
