...
import {
  convertMinuteToHour,
  convertHourtoMinute,
  convertFloatHourToMinute,
  convertMinuteToFloat,
} from "./common-time";
...
export abstract class AppComponentBase {
  ...
  userLevels = [
    {
      value: this.Level.Intern_0,
      name: "Intern_0",
      style: { "background-color": "#B2BEB5" },
    },
    {
      value: this.Level.Intern_1,
      name: "Intern_1",
      style: { "background-color": "#8F9779" },
    },
    {
      value: this.Level.Intern_2,
      name: "Intern_2",
      style: { "background-color": "#665D1E" },
    },
    {
      value: this.Level.Intern_3,
      name: "Intern_3",
      style: { "background-color": "#777" },
    },
    {
      value: this.Level.FresherMinus,
      name: "Fresher-",
      style: { "background-color": "#2196f3" },
    },
    {
      value: this.Level.Fresher,
      name: "Fresher",
      style: { "background-color": "#89CFF0" },
    },
    {
      value: this.Level.FresherPlus,
      name: "Fresher+",
      style: { "background-color": "#318CE7" },
    },
    {
      value: this.Level.JuniorMinus,
      name: "Junior-",
      style: { "background-color": "#BFAFB2" },
    },
    {
      value: this.Level.Junior,
      name: "Junior",
      style: { "background-color": "#A57164" },
    },
    {
      value: this.Level.JuniorPlus,
      name: "Junior+",
      style: { "background-color": "#3B2F2F" },
    },
    {
      value: this.Level.MiddleMinus,
      name: "Middle-",
      style: { "background-color": "#A4C639" },
    },
    {
      value: this.Level.Middle,
      name: "Middle",
      style: { "background-color": "#8DB600" },
    },
    {
      value: this.Level.MiddlePlus,
      name: "Middle+",
      style: { "background-color": "#008000" },
    },
    {
      value: this.Level.SeniorMinus,
      name: "Senior-",
      style: { "background-color": "#F19CBB" },
    },
    {
      value: this.Level.Senior,
      name: "Senior",
      style: { "background-color": "#AB274F" },
    },
    {
      value: this.Level.SeniorPlus,
      name: "Senior+",
  ...
  getVersionReleaseDate() {
    return (
      ...
      this.appSession.application.releaseDate
    );
  }
